...
const _determineErrorCategory = (result: ExecutionResponse): ErrorCategory => {
...
const _determineFinalStatus = (category: ErrorCategory, exitCode: number): ExecutionStatus => {
