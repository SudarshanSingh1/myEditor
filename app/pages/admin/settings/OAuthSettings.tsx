  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center gap-3 border-b border-white/5 pb-4">
        ...
        <div>
          <h2 className="text-xl font-semibold text-white tracking-tight">OAuth Configurations</h2>
          <p className="text-sm text-gray-400">Enable third-party authentication providers.</p>
        </div>
      </div>

      <div className="space-y-6">
        <h3 className="text-lg font-medium text-white border-b border-white/5 pb-2">Google OAuth</h3>
        <Toggle
        ...
        {settings.oauth_google_enabled && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pl-4 border-l-2 border-white/10">
            <TextInput
              label="Client ID"
      ...
      <div className="space-y-6">
        <h3 className="text-lg font-medium text-white border-b border-white/5 pb-2">GitHub OAuth</h3>
        <Toggle
