...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('USER', 'MODERATOR', 'ADMIN', 'SUPER_ADMIN', name='roleenum'), nullable=False),
    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', 'SUSPENDED', 'BANNED', 'PENDING_VERIFICATION', name='statusenum'), nullable=False),
    ...
    sa.Column('visibility', sa.Enum('PRIVATE', 'UNLISTED', 'PUBLIC', name='projectvisibilityenum'), nullable=False),
