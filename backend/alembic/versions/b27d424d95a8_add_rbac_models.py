...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_guest_sessions_fingerprint'), 'guest_sessions', ['fingerprint'], unique=False)
    op.create_index(op.f('ix_guest_sessions_ip_address'), 'guest_sessions', ['ip_address'], unique=False)
    op.create_table('language_contents',
    sa.Column('id', sa.Uuid(), nullable=False),
    ...
    op.create_index(op.f('ix_language_contents_slug'), 'language_contents', ['slug'], unique=True)
    ...
    op.add_column('users', sa.Column('effective_permissions', sa.JSON(), server_default=sa.text("'[]'::json"), nullable=True))
