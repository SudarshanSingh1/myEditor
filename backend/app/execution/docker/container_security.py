...
def get_secure_container_config(image: str, command: str, working_dir: str, binds: Dict[str, Dict[str, str]], mem_limit: str = None) -> Dict[str, Any]:
    """
