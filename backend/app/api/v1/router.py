...
from app.api.v1 import auth, system_settings, projects, workspace, execution, execution_ws, feedback, system_errors, admin, system_status, guest, seo, sessions, two_factor_auth, oauth, github, git, users, rbac, reports, docker, notifications, api_keys, secrets_api, feature_flags, infrastructure
...
router.include_router(feature_flags.router, prefix="/admin/feature-flags", tags=["feature_flags"])
router.include_router(infrastructure.router, prefix="/admin/infrastructure", tags=["infrastructure"])
