...
class Project(Base):
    ...
    visibility = Column(Enum(ProjectVisibilityEnum), default=ProjectVisibilityEnum.PRIVATE, index=True, nullable=False)
    ...
    last_opened_at = Column(DateTime(timezone=True), default=lambda: datetime.now(timezone.utc))
