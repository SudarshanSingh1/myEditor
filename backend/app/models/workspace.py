...
class Folder(Base):
    ...
    project = relationship(
        "Project",
        backref=backref("folders", cascade="all, delete-orphan", passive_deletes=True),
    )
...
class FileVersion(Base):
    ...
    file = relationship(
        "File",
        backref=backref("history", cascade="all, delete-orphan", passive_deletes=True),
    )
