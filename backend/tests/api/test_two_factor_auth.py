...
def test_enable_2fa(client, db_session):
    ...
    resp = client.post(
        "/api/v1/security/2fa/enable", headers=headers, json={"code": "123456"}
    )
    assert resp.status_code == 400
    ...
    # Invalid code
    resp = client.post(
        "/api/v1/security/2fa/enable", headers=headers, json={"code": "000000"}
    )
    assert resp.status_code == 400
    ...
    resp = client.post(
        "/api/v1/security/2fa/enable", headers=headers, json={"code": valid_code}
    )
    assert resp.status_code == 200
...
def test_disable_2fa(client, db_session):
    ...
    # Not enabled
    resp = client.post(
        "/api/v1/security/2fa/disable", headers=headers, json={"code": "123456"}
    )
    assert resp.status_code == 400
    ...
    # Invalid code
    resp = client.post(
        "/api/v1/security/2fa/disable", headers=headers, json={"code": "000000"}
    )
    assert resp.status_code == 400
    ...
    resp = client.post(
        "/api/v1/security/2fa/disable", headers=headers, json={"code": valid_code}
    )
    assert resp.status_code == 200
