...
export const StatusBar: React.FC = () => {
  ...
  return (
    <div className="h-6 w-full bg-blue-600 dark:bg-[#007acc] text-white flex items-center justify-between text-[11px] px-2 select-none flex-shrink-0 z-50 shadow-[0_-1px_2px_rgba(0,0,0,0.1)]">
