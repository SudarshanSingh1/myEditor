...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-white dark:bg-[#050508] pt-32 pb-24 lg:pt-48 lg:pb-32 min-h-[90vh] flex items-center border-b border-zinc-200 dark:border-white/5">
      {/* Background Effects */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
                <Button size="lg" className="rounded-full px-8 h-12 text-base font-semibold shadow-[0_0_20px_rgba(34,197,94,0.3)] hover:shadow-[0_0_30px_rgba(34,197,94,0.5)] transition-all bg-green-500 hover:bg-green-400 text-white border-0" asChild>
                  <Link to="/signup">
                    Start Coding Now <ArrowRight className="ml-2 h-5 w-5" />
                  </Link>
                </Button>
                <Button size="lg" variant="outline" className="rounded-full px-8 h-12 text-base font-semibold border-zinc-200 dark:border-white/10 hover:bg-zinc-100 dark:hover:bg-white/5 bg-transparent text-zinc-900 dark:text-white" asChild>
